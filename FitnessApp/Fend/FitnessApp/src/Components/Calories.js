        ...
        <Grid item xs={12} md={6}>
          <Paper style={{ padding: 20 }} >
            ...
            <Box display="flex" flexDirection="column" alignItems="left" >
                <h1 align="center" style={{backgroundColor: "lightblue"}}>Calorie Tracker</h1>
                <Typography variant="h6" gutterBottom>Your last Sessions calorie Tracker</Typography>
                <Typography variant="body1" gutterBottom>BikeSessions: { }</Typography>
                <Typography variant="body1" gutterBottom>RunningSessions: { }</Typography>
              </Box>
